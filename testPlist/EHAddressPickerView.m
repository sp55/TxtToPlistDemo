...
@interface EHAddressPickerView ()<UIPickerViewDataSource,UIPickerViewDelegate>
...
@implementation EHAddressPickerView

+ (instancetype)shareInstance
{
    static EHAddressPickerView *shareInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        shareInstance = [[EHAddressPickerView alloc] init];
    });
